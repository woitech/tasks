...
public class TrelloClientTest {
    ...
    public void init() {
        ...
        when(trelloConfig.getTrelloBoardsPath()).thenReturn("/boards");
        when(trelloConfig.getTrelloCardsPath()).thenReturn("/cards");
    }
    ...
    public void shouldFetchTrelloBoards() throws URISyntaxException {
        ...
        TrelloBoardDto board = fetchedTrelloBoards.get(0);
        assertEquals("test_id", board.getId());
        assertEquals("test_board", board.getName());
        assertEquals(new ArrayList<>(), board.getLists());
    }
